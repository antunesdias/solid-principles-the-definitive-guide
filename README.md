# SOLID PRINCIPLES - DEFINITIVE GUIDE

<p align="center">
  <img src="https://cloud.githubusercontent.com/assets/8619245/23583699/cdf8192a-0143-11e7-8e11-ae87cdda66f8.jpg">
</p>

<p align="center">
  ¡A simplified but definitive guide to understanding all SOLID Principles!
</p>
...
The SOLID principles were defined in the early 2000s by [Robert C. Martin (Uncle Bob)](http://en.wikipedia.org/wiki/Robert_Cecil_Martin). Uncle Bob elaborated some of these and identified others already existing and said that these principles should be used to get a good management of dependencies in our code.

However, in the beginning these principles were not yet known as SOLID until [Michael Feathers](http://michaelfeathers.silvrback.com/) observed that the initials of these principles fit perfectly under the acronym SOLID and that it was also a very representative name for its definition.
...
#### Coupling:
It as **the degree to which a class, method or any other software entity, is directly linked to another**. This degree of coupling can also be seen as a degree of dependence.
...
**To obtain a good software you must always try to have a low coupling and a high cohesion**, and SOLID principles help you with this task. If you follow these guidelines your code will be more robust, maintainable, reusable and extensible and you will avoid that the code to break in many places every time something is changed.

<p align="center">
  <img width="326" src="https://cloud.githubusercontent.com/assets/8619245/23583901/0a839e78-0149-11e7-8b14-fa2df69b0bc6.png">
</p>
...
Otherwise, if your class assumes more than one responsibility you will have a high coupling causing your code to be fragile with any changes.
...
As usual we do not have time to make a good implementation and in addition, the **DeloRean** has to back to the past urgently. So we decided:
